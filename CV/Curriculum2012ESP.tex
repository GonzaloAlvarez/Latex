...
\ccventry{2011--Presente}{Arquitecto Senior de Software y Sistemas}{Consultor Senior para The Server Labs}{Madrid, Spain}
{. Tareas:
\begin{pitems}
\item $-$ \textsl{Ingenier\'ia de Sistemas Cloud:} Dise\~no y mantenimiento de entornos Cloud para empresas basado en servicios de Amazon, como EC2,
...
\item $-$ \textsl{Arquitecto Cloud:} Dise\~no e implementaci\'on de la arquitectura de varios entornos basados en Cloud Computing
	para empresas internacionales con los objetivos puestos en ofrecer escalabilidad, disponibilidad y reducci\'on de costes.
...
\item $-$ \textsl{Entorno de Integraci\'on Continua Proyecto FARO:} Arquitectura y administraci\'on del entorno de integraci\'on continua
	del proyecto FARO incluyendo la administraci\'on de las herramientas Hudson, SVN y Jira, entre otras, y la arquitectura de los sistemas
	remotos en el Cloud usados para los entornos de integraci\'on continua y pruebas de preproducci\'on.
\item $-$ \textsl{Consultor T\'ecnico:} Preparaci\'on de propuestas, ofertas y documentos t\'ecnicos para preventas y soporte.
\end{pitems}}
...
\cvskill{J2EE}{JSF, JPA, Hibernate, Richfaces, Primefaces.}
...
\cvskill{CI}{Hudson, Jira, SVN, Redmine, Trac, Maven, Ant.}
\cvskill{Agile}{Agilefant, IceScrum, XPlanner.}
\cvskill{Otros}{SQL, \TeX.}
...
\cvline{Redes}{HTTP, DNS, SMTP, FTP, LDAP, Samba, DHCP, SSH, NFS, Security.}
\cvline{Virtualization}{Xen, OpenVZ, VirtualBox, VMWare.}
\cvline{Cloud}{Amazon EC2 S3 AutoScaling ELB Route53, Google Apps.}
\cvline{J2EE Platforms}{Apache Tomcat, IBM Websphere, JBoss.}
