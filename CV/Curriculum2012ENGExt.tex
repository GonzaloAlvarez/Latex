...
\item $-$ \textsl{Cloud Systems Engineer:} Maintainance of Cloud Environments based on Amazon Web Services, such as EC2,
	S3, Elastic IP, Relational Database Services, among others. Development of a Provisioning Tool for Cloud Fast Track
