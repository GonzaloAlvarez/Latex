...
{. Activities:
\begin{pitems}
\item $-$ \textsl{Cloud Systems Engineer:} Maintenance of Cloud Environments based on Amazon Web Services, such as EC2, S3, Elastic IP, 
	Relational Database Services, among others for several multinational companies and consortiums. Development of a Provisioning Tool 
	for Cloud Fast Track in Java intended to ease the deployment of common configurations on new clouds.
\item $-$ \textsl{Cloud Architect:} Design and implementation of the architecture of several Cloud Environments for multinational companies with a particular 
	focus in scalability, availability and cost reduction. 
...
\item $-$ \textsl{Continuous Integration Architect at FARO Project:} Management of the CI environment used by the team developing the FARO project 
	involving management of Hudson, SVN and Jira, along with the administration of the remote systems used for Continuous Deployment and Test Environments.
