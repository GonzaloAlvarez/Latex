...
\ccventry{2011--Today}{Senior Systems and Software Engineer}{Senior Consultant at The Server Labs}{Madrid, Spain}
{. Activities:
\begin{pitems}
\item $-$ \textsl{Software Engineer - Project FARO:} Development of a blahblah for the BBVA Bank.
\item $-$ \textsl{Cloud Systems Engineer:} Management and maintainance of the cloud systems.
\item $-$ \textsl{Technical Consultant:} Participation in the creation of proposals specially related to ESA.
\end{pitems}}
