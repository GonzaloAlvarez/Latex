...
\address{Santuario Valverde 6 L}{28049 Madrid}    % optional, remove the line if not wanted
\mobile{0034 678 252 458}                      % optional, remove the line if not wanted
\altmobile{0049 176 7715 1929}                    % optional, remove the line if not wanted
...
\ccventry{2009--Presente}{Ingeniero de Software y Sistemas para la Agencia Espacial Europea (ESOC/ESA)}
...
\end{pitems}}
\ccventry{2008--2009}{YGT at ESOC/ESA}{Young Graduate Trainee en ESOC/ESA, Secci\'on OPG-GIB}{Darmstadt, Alemania}
{. Tareas:
\begin{pitems}
...
\cventry{Abr 2010}{Agile Development Technologies}{The Server Labs}{ESOC, Darmstadt, Germany}
{Desarrollo de software usando metodolog\'ias Agile y t\'ecnicas SCRUM.}{}
\cventry{Feb 2009}{Eclipse EMF, GEF and GMF Technologies}{OBEO Eclipse Foundation Member}{ESOC, Darmstadt, Germany}
...
\cvskill{Lineal}{Assembler, C, Pascal, Cobol, Fortran, Lisp.}
\cvskill{Objetos}{C++, Java, Delphi, Visual Basic.}
\cvskill{Eclipse}{PDE, RCP, SWT, EMF, GEF, GMF, OCL.}
\cvskill{Distribuido}{RCP, Java RMI, CORBA.}
