...
\ccventry{2009--Presente}{Ingeniero de Software y Sistemas para la Agencia Espacial Europea (ESOC/ESA)}{Serco Contractor on site at ESOC/ESA OPS-GIB Section}{Darmstadt, Germany}
{. Actividades:
\begin{pitems}
...
\item $-$ \textsl{TMTCS Engineer:} Technical responsible for the Telemetry and Telecommand System maintainence. In charge of the
